<template>
  <section
    id="inicio"
    class="relative h-[750px] bg-fixed bg-center bg-no-repeat bg-cover"
    style="background-image: url('/images/playa.jpg')"
  >
    ...
    <div class="relative z-10 flex flex-col justify-center items-center text-white text-center px-4 pt-[15%]">
      ...
      <!-- Botón con logo que cambia a flecha -->
        <a
          href="#sobre-mi"
        ...
        <img
          src="/public/logo.png"
          alt="logo"
          class="w-8 h-8 filter invert group-hover:hidden"
        />

        <!-- Flecha al hacer hover -->
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="w-8 h-8 hidden group-hover:block text-gray-200 hover:text-white transition"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          stroke-width="2"
